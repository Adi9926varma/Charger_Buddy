...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
                    ...
                    <table>
                        <tr>
                            <td><img src="IMAGES/ch_logo.jpg" width="300px" height="450px"></td>
             <td>
                                
      <strutsns:form  action="agentloginaction_logicalcode_action.action" method="post" 
    ...
    <tr align="center"><td colspan="2">
            <strutsns:submit value="agent login" theme="simple" cssClass="buttontheme"/><br>
        No have an account click on  <a href="agentregister.jsp" style="color: blue">register</a>  </td></tr>
    </table>
</strutsns:form>
</td>
                        </tr>
