...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
                    ...
                    <table>
                        <tr>
                            <td><img src="IMAGES/feedI.jpg" width="300px" height="450px"></td>
             <td>
                                
                 <strutsns:form  action="feedbackdb.action" method="post">
    ...
    <tr><td><strutsns:textfield label="Feeddback"  name="feedback" cssClass="texttheme"/> </td></tr>
