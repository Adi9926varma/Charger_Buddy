...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
      ...
      <strutsns:form  action="loginaction_logicalcode_action.action" method="post" 
    ...
    <tr align="center"><td colspan="2">
            <strutsns:submit value="login" theme="simple" cssClass="buttontheme"/><br>
        No have an account click on  <a href="register.jsp" style="color: blue">register</a>  </td></tr>
    </table>
</strutsns:form>
</td>
                        </tr>
