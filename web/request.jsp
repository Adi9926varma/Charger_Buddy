...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
      ...
      <strutsns:form  action="requestdb.action" method="post" >
    ...
    <tr><td><strutsns:combobox 
                list="{'Mobile Charging','Vehicle Charging','USB Cables','Powerbanks','Adaptors','Battery','Earphones'}" 
                label="Request" name="requestType" 
                cssClass="texttheme"/></td></tr>
    <tr><td><strutsns:textfield label="Items"  name="noOfItems" cssClass="texttheme"/>                    </td></tr>
    <tr align="center"><td colspan="2">
            <strutsns:submit value="request" theme="simple" cssClass="buttontheme"/><br>
            </td></tr>
    </table>
</strutsns:form>
</td>
