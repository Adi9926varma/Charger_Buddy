...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
      ...
      <strutsns:form  action="customerpwddb.action" method="post"
    ...
    <table align="center" cellspacing="6px" cellpadding="2px">
        ...
        <tr><td><strutsns:password label="New Password"  name="customerNewPassword" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:password label="Confirm New Password"  name="customercNPassword" cssClass="texttheme"/></td></tr>
