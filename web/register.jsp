...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
      ...
      <strutsns:form  action="registeraction_logicalcode_action.action" method="post" 
        enctype="multipart/form-data"  >
    <table align="center" cellspacing="3px" cellpadding="2px">
        <h1> Register Here</h1>
        <tr><td><strutsns:textfield label="User Id"  name="cId" cssClass="texttheme"/></td></tr>
    ...
    <tr><td><strutsns_dojo:autocompleter 
                list="{'Indore','Bhopal','Gwalior','Delhi','Agra','Mumbai','Dehradun'}" 
    ...
    <tr align="center"><td colspan="2">
            ...
            Already have an account click on  <a href="login.jsp" style="color: blue">login</a> </td></tr>
    </table>
</strutsns:form>
</td>
                        </tr>
