...
<strutsns_dojo:head debug="true"/>
 ...
 <body>
    ...
    <strutsns:div cssClass="formtheme">
      ...
      <strutsns:form  action="adminpwddb.action" method="post"
        enctype="multipart/form-data"  >
    <table align="center" cellspacing="6px" cellpadding="2px">
        <h1> Admin Change Password </h1>
        <tr><td><strutsns:textfield label="Admin Id"  name="adminId" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:password label=" Old Password"  name="password" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:password label="New Password"  name="adminNewPassword" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:password label="Confirm New Password"  name="admincNPassword" cssClass="texttheme"/></td></tr>
