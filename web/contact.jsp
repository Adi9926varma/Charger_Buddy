<%@taglib prefix="strutsns"  uri="/struts-tags"%>
 ...
 <html>
    ...
    <style>
        ...
        body{
        background-image: url('IMAGES/contD.jpg');
        background-size: 100%;
             }
             .tabtheme{
                 font-size: 30px;
 ...
 <body>
    ...
    <nav>
                ...
                <strutsns:a href="productsurl.action">Products</strutsns:a>
    ...
    <div class="service-boxes">
      ...
      <div class="box">
        <h3> Address</h3>
        <p>OFFICE--Scheme No.114 Vijay Nagar Indore .</p>
      </div>
    </div>
  </section>
        ...
        <section class="about">
            <h2>LOCATION</h2><br>
    <p><iframe width="520" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=scheme%20no.114%20near%20astha%20hospital%20vijay%20nagar%20indore%20indore+(buddy%20charger)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='https://www.acadoo.de/leistungen/ghostwriter-doktorarbeit/'>Doktorarbeit akad. Hilfe</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=c26b57055d4df300d0b7d0029f2f9ad62823770f'></script></p>
  </section>
