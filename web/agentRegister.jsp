...
<strutsns_dojo:head debug="true"/>
 ...
 <html>
    ...
    <style>
        ...
        body{
        background-image: url('IMAGES/close-up-electric-car-france.jpg');
        background-size: 100%;
             }
             .tabtheme{
                 font-size: 30px;
 ...
 <body>
    ...
    <nav>
      <!--                    define all the actions here-->
                ...
                <strutsns:a href="agentloginurl.action">Agent Login</strutsns:a>
    ...
    <strutsns:div cssClass="formtheme">
                    ...
                    <table>
                        <tr>
                            <td><img src="IMAGES/chargebuddyicon.jpeg" width="300px" height="450px"></td>
             <td>
                                
      <strutsns:form  action="agentregisteraction_logicalcode_action.action" method="post" 
        enctype="multipart/form-data"  >
    <table align="center" cellspacing="3px" cellpadding="2px">
        <h1> Agent Register </h1>
        <tr><td><strutsns:textfield label="Agent Id"  name="agentId" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:textfield label="Full name"  name="fullName" cssClass="texttheme"/></td></tr>
    <tr><td><strutsns:password label="Password"  name="password" cssClass="texttheme"/></td></tr>
    <tr><td><strutsns:textfield label="Contact"  name="contact" cssClass="texttheme"/></td></tr>
    <tr><td><strutsns_dojo:datetimepicker  label="DOB"  name="dob" cssClass="texttheme"/> </td></tr>
    <tr><td><strutsns:textfield label="Address"  name="address" cssClass="texttheme"/></td></tr>
    <tr align="center"><td colspan="2">
            <strutsns:submit value="register" theme="simple" cssClass="buttontheme"/><br>
            Already have an account click on  <a href="agentlogin.jsp" style="color: blue">login</a> </td></tr>
    </table>
</strutsns:form>
</td>
                        </tr>
